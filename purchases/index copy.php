            ...
            <div class="container">
                ...
                <div class="row mx-1">
                    <div class="col p-2">
                        <div class="row mx-1">
                            <div class="col p-2">
                                <h3 class="p-2">BOOK PURCHASES</h3>
                            </div>
                            <div class="col p-2">
                                <?php if(hasRole(['owner','partner'])):?>
                                    <div class="col p-3">
                                        <button class="btn btn-sm btn-flat btn-outline-success btn-click right" data-title='record purchase' data-section='purchase'><i class="fa fa-plus-circle"></i> Purchase</button>
                                    </div>
                                <?php endif;?>
                            </div>
                        </div>
                        ...
                        <div class="p-2">
                            <?php
                                $sql = "SELECT cp.*,ci.name,ci.units,ci.details FROM cashbook_purchases cp
