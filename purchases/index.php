                        ...
                        <div class="row mx-1">
                            ...
                            <div class="col p-2">
                                <?php if(hasRole(['owner','partner'])):?>
                                    <div class="col p-3">
                                        <button class="btn btn-sm btn-flat btn-outline-success btn-click right" data-title='add purchase' data-section='purchase'><i class="fa fa-plus-circle"></i> Purchase</button>
                                    </div>
                                <?php endif;?>
                            </div>
                        </div>
