    ...
    ?>
                                ...
                                <table class="table table-sm table-striped dataTable">
                                    <thead>
                                        <tr>
                                            <th>#</th>
                                            <th>Name</th>
                                            <th class='text-right'>Contact1</th>
                                            <th class='text-right'>Contact2</th>
                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                            <tr class='hover hover-hide-content'>
                                                <td><?=$s++;?></td>
                                                <td><?=$r['name'];?></td>
                                                <td class='text-right'><?=$r['contact1'];?></td>
                                                <td class='text-right'><?=$r['contact2'];?></td>
        ...
        ?>
            <script>
                ...
                $(document).on('click','.saveRouteManager',function(){
                    submitSingleForm("newRouteManagerForm", "../books/save/index.php");
                });
                ...
                $(document).on('click','.view-route-manager',function(){
                    $('#central-modal').show();
